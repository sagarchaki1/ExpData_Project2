...
Data
The data for this assignment are available from the course web site as a single zip file. (Downloaded and imported into R Studio)
...
The following questions and tasks in your exploratory analysis have been answered.
